...
class InsuranceStatusScreen extends GetWidget<InsuranceStatusController> {
  @override
                                        ...
                                        child: Container(
                                            ...
                                            child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                    ...
                                                    filled: true,
                                                    fillColor: ColorConstant.gray4003f,
                                                    isDense: true,
                                                    contentPadding: EdgeInsets.only(top: getVerticalSize(2.06), bottom: getVerticalSize(3.06))),
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: GestureDetector(
                                                                            ...
                                                                            child: Container(width: getHorizontalSize(375.00), margin: EdgeInsets.only(left: getHorizontalSize(2.00)), child: Text("lbl_check".tr, maxLines: null, textAlign: TextAlign.center, style: AppStyle.textstyleinterbold22.copyWith(fontSize: getFontSize(22))))))
                                                                  ]))),
                                                      Align(
                                                          alignment: Alignment
                                                              .bottomLeft,
